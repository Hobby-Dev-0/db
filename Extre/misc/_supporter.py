...
from Extre.misc._decorators import *
from Extre.misc._wrappers import eod, eor

from .. import ExtremedB, extremepro_bot
from ..dB.core import LIST
from ..dB.database import Var

ALIVE_NAME = extremepro_bot.me.first_name
...
j_cmd = admin_cmd
command = extremepiro_cmd
register = extremepiro_cmd
...
#   ExtremeProUserbot Don't Need This Configs
...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ExtremeProUserbot")
        OCR_SPACE_API_KEY = os.environ.get("OCR_SPACE_API_KEY", None)
        G_BAN_LOGGER_GROUP = int(ExtremedB.get("LOG_CHANNEL"))
        ...
        UB_BLACK_LIST_CHAT = [
            int(blacklist) for blacklist in ExtremedB.get("BLACKLIST_CHATS")
        ]
